  ...
  return (
    <div className={styles.footerContainer}>
      ...
      <div className={styles.footerInfo}>
        ...
        <div className={styles.footerInfoItem}>
          <h4>Our Contacts</h4>
          <h5>contact@contact.com</h5>
          <h5>+1 111 111 11 11</h5>
        </div>
      </div>
      <div className={styles.verticalLine}></div>
      <div className={styles.footerContext}>
        <h2>Context</h2>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempore aliquam unde quod dolore similique fuga debitis minus ex recusandae odio.</p>
      </div>
    </div>
  )
}
